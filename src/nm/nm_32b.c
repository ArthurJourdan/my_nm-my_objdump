...
static size_t get_nb_symbols(Elf32_Shdr *symbol_table)
{
...
static symbol_t get_symbol(Elf32_Ehdr *header, Elf32_Shdr *section_header,
...
static symbol_t *get_symbols(Elf32_Ehdr *header, Elf32_Shdr *section_header,
    Elf32_Shdr *symbol_table, size_t nb_symbols)
{
...
static Elf32_Shdr *get_symbol_table(Elf32_Ehdr *header, Elf32_Shdr *sections)
{
...
bool nm_32(void *header)
{
    ...
    Elf32_Shdr *my_symbol_table = get_symbol_table(my_header, my_sections);
